...
void predict_size_v2(size_t* dna_size, size_t* next_gen_dna_size, GPUDnaMutator* dna_mutator_list,
                     TypeMutation* tab_mut, int* nb_mutations, int* mutations_offset,
                     unsigned long long* gpu_counters, int* next_generation_reproducer,
                     int max_genome_length, int min_genome_length, int nb_indiv);

__global__
void compute_next_gen_dna_offset(size_t* next_gen_dna_size, size_t* next_gen_dna_offset);


__global__ void do_mutation_v2(TypeMutation* tab_mut, int* nb_mutations, size_t* dna_size, size_t* dna_offset,
                               char* dna, char* next_gen_dna, size_t* next_gen_dna_size, size_t* next_gen_dna_offset,
                               int* next_generation_reproducer, int* mutations_offset,
                               unsigned long long int* nb_mut_bp);
