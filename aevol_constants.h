...
const boost::dynamic_bitset<> PROM_SEQ(std::string("0110100100111001101010"));
// terminator
...
constexpr int8_t SD_TO_START = SHINE_DAL_SIZE + SD_START_SPACER + CODON_SIZE;
 const boost::dynamic_bitset<> SHINE_DAL_SEQ(std::string("0001100000110"));
// stop
const boost::dynamic_bitset<> PROTEIN_END(std::string("100")); // CODON_STOP
