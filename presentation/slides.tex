...
\only<5->{
 ...
 \begin{itemize}
  ...
  \only<9>{
  \begin{itemize}
   \item Small insertion (max = 6) of random value (0 or 1) at some position in DNA
   \item Small deletion (max = 6) at some position in DNA
   \item Switch of the value of up to 6 value in the DNA array
   \item Large duplication of a part of the DNA that is inserted at some position
   \item Large deletion of a part of the DNA
  \end{itemize}
  }
  }
 \end{itemize}
